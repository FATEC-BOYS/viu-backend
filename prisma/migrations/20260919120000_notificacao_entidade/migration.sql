...
ALTER TABLE "notificacoes" ADD COLUMN "entidadeTipo" TEXT;
ALTER TABLE "notificacoes" ADD COLUMN "entidadeId" TEXT;
...
CREATE INDEX "notificacoes_usuarioId_criadoEm_id_idx" ON "notificacoes"("usuarioId", "criadoEm", "id");

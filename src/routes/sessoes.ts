...
import { listSessoes, revokeSessao, revokeOtherSessoes } from '../controllers/sessaoController.js'
...
export async function sessoesRoutes(fastify: FastifyInstance) {
  ...
  fastify.post('/sessoes/revoke-others', { preHandler: [authenticate] }, revokeOtherSessoes)
}